...
def gen_datapoint(rgb_fn, depth_fn, rgb_next_fn, depth_next_fn, flow_fn, n = 8192, max_cut = 35, focal_length=725.0087):
    ...
    future_pix1_x = sampled_pix1_x + sampled_scene_flow_x
    future_pix1_y = sampled_pix1_y + sampled_scene_flow_y
    future_depth_np = depth_np + flow_np[:,:,2]
    future_pos1 = current_pos1 + np.hstack([sampled_scene_flow_x, sampled_scene_flow_y, sampled_scene_flow_z])
