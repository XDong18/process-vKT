...
def proc_one_scene_vkt(scene_root):
    ...
    for rgb_fn in sorted(os.listdir(rgb_root)):
        ...
        depth_next_fn = glob.glob(os.path.join(rgb_root, '*' + str(int_idx+1).zfill(5) + '*'))[0]
        sceneflow_next_fn = glob.glob(os.path.join(rgb_root, '*' + str(int_idx+1).zfill(5) + '*'))[0]
